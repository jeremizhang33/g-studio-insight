...
window.DATA = {
  ...
  // ===== 最新版本动态 =====
  latestVersions: [
    { product:"和平精英", ver:"v1.35.12", name:"丝路贺新春·7周年电玩嘉年华预热", date:"2026-04", color:"#faad14",
      tags:["7周年「电玩嘉年华」4月14日上线","4月7日热更公告","体验服v1.36.11招募中(截止4月20日)","App Store评分4.33(1525万条)","TapTap 5.5分","iOS包体3.68GB"],
      verified: true, verifySource: "App Store Lookup API/好游快爆/233乐园", verifyNote: "版本号v1.35.12确认，iOS 3.68GB，Android约1.94GB，4月14日将更新7周年版本" },
    { product:"王者荣耀", ver:"11.3.1.1", name:"S43 陌上相逢", date:"2026-04", color:"#ff7d00",
      tags:["S43赛季4月1日正式上线","新英雄元流之子·刺客(登录即送)","新召唤师技能汇流为兵","小屋农场新玩法","11位英雄平衡调整","王者荣耀世界4月10日联动","App Store评分3.28","包体暴增681MB至3.62GB"],
      verified: true, verifySource: "App Store Lookup API/17173/游民星空/高手游", verifyNote: "版本11.3.1.1确认(4月1日更新)，iOS 3.62GB(较上版增加681MB)，Android约1.71GB" },
    { product:"无畏契约", ver:"破棘新生", name:"破棘新生·新英雄维斯", date:"2026-04", color:"#f53f3f",
      tags:["「破棘新生」版本4月9日上线","新哨卫英雄维斯","6V6热身团竞模式","爆能大乱斗4月28日上线","极客星喵套装上架","TapTap 7.8分"],
      verified: true, verifySource: "17173/切游网/网易UU/4399", verifyNote: "4月9日版本更新确认，新英雄维斯(防守型)，预下载4月2日已开放" },
    ...
    { product:"三角洲行动", ver:"1.201.37110", name:"蝶变时刻(S8)·S9回声赛季预热", date:"2026-04", color:"#165dff",
      tags:["国服DAU突破5000万(腾讯财报实锤)","S9回声赛季4月16日上线","新干员(侦察型)+重型狙M82","末世求生丧尸玩法(4.1-4.9限时)","烽火职业联赛开打","TapTap 6.2分","盗号安全事件引发关注"],
      verified: true, verifySource: "17173/3DM/233乐园/应用宝/TapTap", verifyNote: "版本1.201.37110确认，S9定档4月16日，DAU破5000万(3/18官宣)" },
